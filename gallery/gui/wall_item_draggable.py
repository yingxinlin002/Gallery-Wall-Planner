...
from gallery.gui import wall_canvas
...
from gallery.gui.wall_item import WallItem, ItemLocation
from gallery.models.wall_line import Orientation, HorizontalAlignment, VerticalAlignment, SingleLine
