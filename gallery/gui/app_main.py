...
from gallery.models.project_exporter import export_gallery_to_excel  # Import Artwork class
...
class AppMain():
    ...
    def _load_home_screen(self):
        ...
        from gallery.gui.screen_home import ScreenHome
        self.frame_contents = ScreenHome(self)
        print("Home screen loaded...")
        
    def _load_new_gallery_screen(self):
        """Load the new gallery screen"""
        from gallery.gui.screen_new_gallery_ui import ScreenNewGalleryUI
