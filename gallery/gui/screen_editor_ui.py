...
from gallery.gui.wall_canvas import WallCanvas
from gallery.models.structures import CanvasDimensions, Padding
from gallery.gui.popup_install_instruct import InstallInstructionPopup
from gallery.models.artwork import Artwork
from gallery.gui.popup_snap_lines import PopupSnapLines
from gallery.models.wall_line import SingleLine, Orientation
from gallery.gui.collapsible_menu import CollapsibleMenu
from gallery.gui.scroll_box_vertical import ScrollBoxVertical
from gallery.gui.btn_snap_line import BTNSnapLine
from gallery.gui.popup_even_spacing import PopupEvenSpacing
...
class ScreenEditorUI(ScreenBase):
    ...
    def create_artwork_list_frame(self):
        ...
        if len(self.AppMain.gallery.current_wall.artwork) > 0 or len(self.AppMain.gallery.unplaced_artwork) > 0:
            from gallery.gui.btn_wall_item import BTNWallItem, WallItemState
