...
class NewGalleryUI:
    ...
    def show_wall_info_page(self):
        ...
        # Wall Color
        tk.Label(self.root, text="Wall Color:", font=("Arial", 12)).pack(pady=5)
        ...
        tk.Button(self.root, text="Submit", command=self.submit_wall_info, width=20, bg="#4CAF50", fg="white", font=("Helvetica", 12, "bold"), relief="raised", padx=10, pady=5).pack(pady=10)
