...
class PopupNewWallItem(PopupBase):
    def __init__(self, AppMain : AppMain, *args, **kwargs):
        super().__init__(AppMain, "New Wall Item", 600, 400, *args, **kwargs)
    ...
    def load_content(self):
        self.title_label = ttk.Label(self, text="New Wall Item", font=self.styles["title_font"])
        ...
        self.name_var = tk.StringVar(value="Door sign")
        ...
        #     self.artwork_hanging_point_var = tk.StringVar(value="")
        ...
        #     self.artwork_price_var = tk.StringVar(value="")
